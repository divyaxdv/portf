...
const LINKTREE_URL = "https://linktr.ee/akaverselive";
...
const SOCIALS: {
  ...
  { label: "Medium", href: "https://medium.com", Icon: IconMedium },
  { label: "Dev.to", href: "https://dev.to", Icon: IconDevTo },
            ...
            <div className="contact-me-top">
              ...
              <div className="contact-me-copy">
                ...
                <div className="contact-me-actions">
                  ...
                  <a
                    className="contact-me-pill contact-me-pill--link"
                    href={LINKTREE_URL}
                    target="_blank"
                    rel="noreferrer"
                  >
                    <Link2 size={16} strokeWidth={2} aria-hidden />
                    linktree: akaverselive
                  </a>
                </div>
              </div>
            </div>

            <div className="contact-me-social-panel">
              <ul className="contact-me-socials" aria-label="Social links">
...
function IconMedium({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden>
      <path
        fill="currentColor"
        d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.77 6.41-3.94 6.41-2.17 0-3.94-2.87-3.94-6.41 0-3.54 1.77-6.41 3.94-6.41 2.17 0 3.94 2.87 3.94 6.41zM24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75 0-3.17.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z"
      />
    </svg>
  );
}

function IconDevTo({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden>
